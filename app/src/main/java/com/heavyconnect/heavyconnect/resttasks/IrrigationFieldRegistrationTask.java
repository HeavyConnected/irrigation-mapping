 ...
 */
public class IrrigationFieldRegistrationTask extends AsyncTask<Object, Void, IrrigationFieldsDetailsResult> {

    private TaskCallback callback;

    public IrrigationFieldRegistrationTask(TaskCallback userCallback) {
    ...
    protected IrrigationFieldsDetailsResult doInBackground(Object... params) {
        ...
        try {
            return retrofitClient.client.createField(token, field.getFieldName(), field.getPipeLength(),
                    field.getPipeDepth(), field.getPipeRow(), field.getLongitude(),
                    field.getLatitude());
        } catch (Exception e) {
            e.printStackTrace();
        }
